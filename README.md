...
Sou uma desenvolvedora focada no ecossistema **Back-end e Visão Computacional**, unindo lógica robusta com inteligência artificial para resolver problemas reais do cotidiano e do mercado.
...
## 🔬 Pesquisa e Projetos de Destaque

### 🏥 Projeto YOLO Hospitalar (Iniciação Científica)
Desenvolvimento de um software de Visão Computacional focado na automação e identificação de insumos e instrumentos cirúrgicos em ambiente hospitalar, utilizando o modelo **YOLOv8** para redução de erro humano e otimização de tempo.
